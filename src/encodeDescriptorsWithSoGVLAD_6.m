...
vladQueryPath = fullfile(holidayPath,'vlad_original_query_500_100.mat');
vladTestPath = fullfile(holidayPath, 'vlad_original_test_991_100.mat');
...
%-------------------------------------------------------------------------------------------
 z1 = vl_vlad(descrs, encoder.words, assign, 'Unnormalized');%'SquareRoot', 'NormalizeComponents');%, ...
 z1 = sqrt(z1);
 %                 'SquareRoot', ...
 %                 'NormalizeComponents'
